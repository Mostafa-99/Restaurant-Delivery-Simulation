...
GUI::GUI()
{
	pWind = new window(WindWidth+40,WindHeight,0,0); 
	...
	OrdersClrs[TYPE_FROZ] = FROZEN;		//Frozen-order color
...
void GUI::PrintMessage(int x,int y,string msg) const	//Prints a message on status bar
{
	...
	//10
	// WindHeight - (int)(StatusBarHeight / 1.5)
}